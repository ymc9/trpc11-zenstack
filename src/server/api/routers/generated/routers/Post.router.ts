...
export default function createRouter() {
    return createTRPCRouter({
        ...
        createMany: procedure
            .input($Schema.PostInputSchema.createMany.optional())
            .mutation(async ({ ctx, input }) =>
                checkMutate(db(ctx).post.createMany(input as any))
            ),
        ...
        deleteMany: procedure
            .input($Schema.PostInputSchema.deleteMany.optional())
            .mutation(async ({ ctx, input }) =>
        ...
        findFirst: procedure
            .input($Schema.PostInputSchema.findFirst.optional())
            .query(({ ctx, input }) =>
        ...
        findMany: procedure
            .input($Schema.PostInputSchema.findMany.optional())
            .query(({ ctx, input }) =>
        ...
        groupBy: procedure
            ...
            .query(({ ctx, input }) =>
                checkRead(db(ctx).post.groupBy(input as any))
            ),
        ...
        count: procedure
            .input($Schema.PostInputSchema.count.optional())
            .query(({ ctx, input }) =>
                checkRead(db(ctx).post.count(input as any))
            ),
    });
}
